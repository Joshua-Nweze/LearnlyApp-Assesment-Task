        ...
        <div>
            <div class="flex min-h-full flex-col justify-center py-5 lg:px-8">
                <div class="">
                    ...
                    <div class="bg-gray-100 mt-5 sm:mx-auto sm:w-full sm:max-w-sm rounded-xl p-5">
                        ...
                        <form class="space-y-4" @submit.prevent="">
                            <div>
                                <input type="text" name="username" placeholder="Username" required class="block w-full text-base rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-2">
                            </div>
                        ...
                        <div class="text-center text-sm mt-5 text-black">
